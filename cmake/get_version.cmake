...
IF(EXISTS "${VERSION_SOURCE_DIR}/version.cmake")
  ...
  # fallback: hardcoded version info for custom build
  set(OONF_LIB_GIT "custom-build")
  set(VERSION "0.1.0")

  message ("Git commit: ${OONF_LIB_GIT}, Git version: ${VERSION}")

  # write version.cmake so later stages find it
